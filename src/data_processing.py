...
def procesar_y_guardar_datos(ruta_raw, ruta_processed, ruta_toy):
    ...
    #Se separan las condiciones de borde, implicit distance cercano a 0
    tol = 1e-4
    #Se crea columna booleana para saber qué puntos pertenecen al ala
    df['es_borde'] = df['implicit_distance'].abs() < tol 

    #Se escala a [-1, 1] todo el dataset
    ...
    #Para probar con datos toy, se asignan 250 muestras del ala y 250 del interior
